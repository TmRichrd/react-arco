...
import localeSettingRoles from "../pages/setting-roles/locale/en-US"
import localeSettingMenuList from "../pages/setting-menulist/locale/en-US"
import localeSettingUser from "../pages/setting-user/locale/en-US"
export default {
